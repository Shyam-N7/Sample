...
export default function SeventhsemInfo() {
  const navigate = useNavigate();
  return (
    <div className="HomepageBody">
      <div className="sem1_title">Semester-7</div>
      <div className="timetable_container">
        <div className="title2">
          Time Table
        </div>
        <div className="timetable_button">
          <button onClick={() => navigate(`/timetablesem7/a_sec`)} className="timetable_button1">
            A Section
          </button>
          <button onClick={() => navigate(`/timetablesem7/b_sec`)} className="timetable_button1">
            B Section
          </button>
          <button onClick={() => navigate(`/timetablesem7/c_sec`)} className="timetable_button1">
            C Section
          </button>
        </div>
      </div>
      <div className="question_paper_container">
        ...
        <button onClick={() => navigate(`/assignments/mqp_sem7`)} className="qp_btn">
          Assignments
        </button>
        <button onClick={() => navigate(`/assignments/mqp_sem7`)} className="qp_btn">
          MQP
