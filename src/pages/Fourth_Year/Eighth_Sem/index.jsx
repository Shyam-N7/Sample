...
export default function EighthsemInfo() {
    ...
    <div className="HomepageBody">
      ...
      <div className="timetable_container">
        ...
        <div className="timetable_button">
          <button onClick={() => navigate(`/timetablesem8/a_sec`)} className="timetable_button1">
            A Section
          </button>
          <button onClick={() => navigate(`/timetablesem8/b_sec`)} className="timetable_button1">
            B Section
          </button>
          <button onClick={() => navigate(`/timetablesem8/c_sec`)} className="timetable_button1">
            C Section
          </button>
        </div>
      </div>
      <div className="question_paper_container">
        ...
        <button onClick={() => navigate(`/assignments/mqp_sem8`)} className="qp_btn">
          Assignments
        </button>
        <button onClick={() => navigate(`/assignments/mqp_sem8`)} className="qp_btn">
          MQP
