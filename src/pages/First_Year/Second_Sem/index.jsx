...
export default function SecondsemInfo() {
  const navigate = useNavigate();
  return (
    <div className="HomepageBody">
      <div className="sem2_title">Semester-2</div>
      <div className="timetable_container">
        <div className="title2">
          Time Table
        </div>
        <div className="timetable_button">
          <button onClick={() => navigate(`/timetablesem2/a_sec`)} className="timetable_button1">
            A Section
          </button>
          <button onClick={() => navigate(`/timetablesem2/b_sec`)} className="timetable_button1">
            B Section
          </button>
          <button onClick={() => navigate(`/timetablesem2/c_sec`)} className="timetable_button1">
            C Section
          </button>
        </div>
      </div>
      <div className="question_paper_container">
        ...
        <button onClick={() => navigate(`/assignments/mqp_sem2`)} className="qp_btn">
          Assignments
        </button>
        <button onClick={() => navigate(`/assignments/mqp_sem2`)} className="qp_btn">
          MQP
