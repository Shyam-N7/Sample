          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="inputs_container">
              <div className="login_input">
                ...
                <input className="input_login" placeholder="Enter email" onChange={e => setEmail(e.target.value)} />
              </div>
              <div className="login_input">
                <label className="login_lable">Password</label>
                <input className="input_login" placeholder="Enter password" type="password" onChange={e => setPassword(e.target.value)} />
              </div>
